...
class PiSmart(_Basic_class):
    ...
    def LED_init(self):
        from led import LED
        self._red = LED(LED.RED)
        self._blue = LED(LED.BLUE)
        self._red.DEBUG = 'error'
        self._blue.DEBUG = 'error'


    def Motor_init(self):
        from motor import Motor
        self._motor_a = Motor('MotorA')
        self._motor_b = Motor('MotorB')
    ...
    @property
    def Red_LED(self):
        return self._red.brightness
    @Red_LED.setter
    def Red_LED(self, value):
        self._red.brightness = value
    @property
    def Blue_LED(self):
        return self._blue.brightness
    @Blue_LED.setter
    def Blue_LED(self, value):
        self._blue.brightness = value
